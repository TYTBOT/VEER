...
if not VEERBOT:get(DEV_VEER..":token") then
...
VEERBOT:set(DEV_VEER..":token",token)
end 
else
...
if not VEERBOT:get(DEV_VEER..":SUDO:ID") then
io.write('\27[1;31m ↡ ارسل ايدي مطور الاساسي |\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOID = io.read()
if SUDOID ~= '' then
io.write('\n\27[1;34m تم حفظ ايدي المطور |\n\27[0;39;49m')
VEERBOT:set(DEV_VEER..":SUDO:ID",SUDOID)
else
print('\n\27[1;34m لم يتم حفظ ايدي المطور |')
end 
os.execute('lua VEER.lua')
end
if not VEERBOT:get(DEV_VEER..":SUDO:USERNAME") then
io.write('\27[1;31m ↡ ارسل معرف المطور الاساسي |\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ معرف المطور |\n\27[0;39;49m')
VEERBOT:set(DEV_VEER..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
...
config = {
token = VEERBOT:get(DEV_VEER..":token"),
SUDO = VEERBOT:get(DEV_VEER..":SUDO:ID"),
USERNAME = VEERBOT:get(DEV_VEER..":SUDO:USERNAME"), }
...
f:close()  
VEERBOT:del(DEV_VEER..":token")
VEERBOT:del(DEV_VEER..":SUDO:ID")
VEERBOT:del(DEV_VEER..":SUDO:USERNAME")
VEERBOT:del(DEV_VEER..":NAMEBOT")
end  
...
if text == 'فتح الكل' and is_devtaha(msg) then   taha = '*🚸¦* تم فتح جميع الاوامر   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      VEERBOT:del(VEER_ID..'lock:photo'..bot_id)    VEERBOT:del(VEER_ID..'lock:vico'..bot_id)    VEERBOT:del(VEER_ID..'lock:ste'..bot_id)    VEERBOT:del(VEER_ID..'lock:file'..bot_id)    VEERBOT:del(VEER_ID..'lock:phon'..bot_id)    VEERBOT:del(VEER_ID..'lock:links'..bot_id)    VEERBOT:del(VEER_ID..'lock:ved'..bot_id)    VEERBOT:del(VEER_ID..'lock:fwd'..bot_id)    VEERBOT:del(VEER_ID..'lock:gif'..bot_id)    VEERBOT:del(VEER_ID..'lock:musec'..bot_id)    end      
if text == 'قفل الكل' and is_devtaha(msg) then   taha = '*📛¦* تم قفل جميع الاوامر  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      VEERBOT:set(VEER_ID..'lock:photo'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:vico'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:ste'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:file'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:phon'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:links'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:ved'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:fwd'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:gif'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:musec'..bot_id,true)     end   
if text == 'فتح الصور' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصور   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:photo'..bot_id) end  
if text == 'قفل الصور' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصور  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:photo'..bot_id,true) end 
if text == 'فتح الصوت' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الصوت   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:vico'..bot_id) end  
if text == 'قفل الصوت' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الصوت  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:vico'..bot_id,true) end 
if text == 'فتح الاغاني' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الاغاني   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:musec'..bot_id) end  
if text == 'قفل الاغاني' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الاغاني  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:musec'..bot_id,true) end 
if text == 'فتح المتحركه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح المتحركه   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:gif'..bot_id) end  
if text == 'قفل المتحركه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل المتحركه  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:gif'..bot_id,true) end 
if text == 'فتح التوجيه' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح التوجيه   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:fwd'..bot_id) end  
if text == 'قفل التوجيه' and is_devtaha(msg) then  taha = '*📛¦* تم قفل التوحيه  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:fwd'..bot_id,true) end 
if text == 'فتح الفيديو' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الفيديو   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:ved'..bot_id) end  
if text == 'قفل الفيديو' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الفيديو  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:ved'..bot_id,true) end 
if text == 'فتح الروابط' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الروابط   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:links'..bot_id) end  
if text == 'قفل الروابط' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الروابط  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:links'..bot_id,true) end 
if text == 'فتح الجهات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الجهات   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:phon'..bot_id) end  
if text == 'قفل الجهات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الجهات  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:phon'..bot_id,true) end 
if text == 'فتح الملفات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملفات   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:file'..bot_id) end  
if text == 'قفل الملفات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملفات  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:file'..bot_id,true) end 
if text == 'فتح الملصقات' and is_devtaha(msg) then  taha = '*🚸¦* تم فتح الملصقات   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:ste'..bot_id) end  
if text == 'قفل الملصقات' and is_devtaha(msg) then  taha = '*📛¦* تم قفل الملصقات  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:ste'..bot_id,true) end 
...
if text == 'مسح المحظورين 📢' and is_devtaha(msg) then       local list = VEERBOT:smembers(VEER_ID..'pv:ban'..msg.chat_id_)   for k,v in pairs(list) do     VEERBOT:del(VEER_ID..'pv:ban'..msg.chat_id_)   VEERBOT:del('numlocktextpv'..bot_id..v)  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'📛*¦* تم مسح المحظورين', 1, 'md')     end
if text == 'تفعيل البوت الخدمي 🎮' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل البوت خدمي  ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:del(VEER_ID..'lock:bot:free'..bot_id) end 
if text == 'تعطيل البوت الخدمي 🚸' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل البوت الخدمي  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:set(VEER_ID..'lock:bot:free'..bot_id,true) end
if text == 'تفعيل تواصل 📨' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل بوت التواصل  ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:del(VEER_ID..'lock:botl'..bot_id) end 
if text == 'تعطيل تواصل 📩' and is_devtaha(msg) then taha = '*📛¦*تم تعطيل التواصل  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:set(VEER_ID..'lock:botl'..bot_id,true) end
if text == 'تحديث ♻' and is_devtaha(msg) then  local filed = io.popen('ls plugins_'):lines() for files in filed do if files:match(".lua$") then end end dofile('VEER.lua') load_plugins() io.popen("rm -rf ~/.telegram-cli/data/audio/*") io.popen("rm -rf ~/.telegram-cli/data/document/*") io.popen("rm -rf ~/.telegram-cli/data/photo/*") io.popen("rm -rf ~/.telegram-cli/data/sticker/*") io.popen("rm -rf ~/.telegram-cli/data/temp/*") io.popen("rm -rf ~/.telegram-cli/data/thumb/*") io.popen("rm -rf ~/.telegram-cli/data/video/*") io.popen("rm -rf ~/.telegram-cli/data/voice/*") io.popen("rm -rf ~/.telegram-cli/data/profile_photo/*")   VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*📛¦* تم تحديث البوت', 1, 'md') end 
if text == "وضع اسم البوت ⚡" and is_devtaha(msg) then VEERBOT:setex(VEER_ID..'namebot:witting'..msg.sender_user_id_,300,true) VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📛¦* ارسل لي الاسم 📯\n",1, 'md')  end
if text == 'مسح المميزين عام 🌟' and is_devtaha(msg) then      local list = VEERBOT:smembers(VEER_ID..'vip:groups')    if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    VEERBOT:srem(VEER_ID.."vip:groups",v)    num = num + 1  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المميزين عام *\n', 1, 'md')   end
if text == 'مسح المطورين 👮' and is_devtaha(msg) then     local list = VEERBOT:smembers(VEER_ID..'sudo:bot')    if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد مطورين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    VEERBOT:srem(VEER_ID.."sudo:bot",v)    num = num + 1  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المطورين *\n', 1, 'md')   end
if text == 'مسح قائمه العام 🚷' and is_devtaha(msg) then   local list = VEERBOT:smembers(VEER_ID..'VEER:gbaned')    if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    VEERBOT:srem(VEER_ID.."VEER:gbaned",v)    num = num + 1  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md')   end
...
if text == 'تفعيل رساله الترحيب 🎌' and is_devtaha(msg) then local  taha = '*📛¦*تم تفعيل رسالة ترحيب عند الاضافه  ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:del(VEER_ID..'lock:klsh:add'..bot_id) end 
if text == 'تعطيل رساله الترحيب 📱' and is_devtaha(msg) then taha = '*📮¦*تم تعطيل رسالة ترحيب عند الاضافه  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:set(VEER_ID..'lock:klsh:add'..bot_id,true) end
if text == "حذف رد التواصل 🔧" and is_devtaha(msg) then  VEERBOT:del(VEER_ID.."pvstart") VEER_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف رد التوصل', 1, "md") end 
if text == "حذف كليشه ستارت 🃏" and is_devtaha(msg) then  VEERBOT:del(VEER_ID.."start:msgofstart1") VEER_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه ستارت', 1, "md") end 
if text == "حذف كليشه المطور 🀄" and is_devtaha(msg) then  VEERBOT:del(VEER_ID.."dev") VEER_sendMsg( msg.chat_id_, msg.id_, 1, '*📛¦*تم حذف كليشه المطور', 1, "md") end 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم مسح الصلاحيه *\n✓", 1, "md") 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📬¦ تم اضافه الامر *\n✓", 1, "md") 
VEERBOT:del(VEER_ID.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
