...
tahaid = VEERBOT:get(VEER_ID..'add:ch:id')
tahauser = VEERBOT:get(VEER_ID..'add:ch:username')
...
t = 'منشئ'
elseif VEERBOT:sismember(VEER_ID..'modergroup'..chat_id,user_id) then
t = VEERBOT:get(VEER_ID.."Comd:New:rt:user:"..chat_id..user_id) or 'مدير 👨🏻‍💼'
elseif VEERBOT:sismember(VEER_ID..'mods:'..chat_id,user_id) then
t = VEERBOT:get(VEER_ID.."Comd:New:rt:user:"..chat_id..user_id) or 'ادمن 👮🏻‍♂'
elseif VEERBOT:sismember(VEER_ID..'vip:groups',user_id) then
t = 'مميز عام'
elseif VEERBOT:sismember(VEER_ID..'vip:group'..chat_id,user_id) then
t = VEERBOT:get(VEER_ID.."Comd:New:rt:user:"..chat_id..user_id) or 'مميز ⭐'
else
t = 'عضو'
end
return t 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*✔️┇تم مسح كليشه ترحيب عند اضافه البوت *\n', 1, 'md') 
end

if text == 'تحديث' and is_devtaha(msg) then  
dofile('VEER.lua')  
load_plugins()
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*✔️┇تم تحديث الملفات ♻* \n', 1, 'md') 
end 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇تنبيــــه لا استطيع تفعيل المجموعه انا لست ادمن يرجى ترقيتي ادمن *\n✓\n", 1, "md") 
return false  end 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if VEERBOT:sismember(VEER_ID..'bot:gps:id',msg.chat_id_) then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇المجموعه تم تفعيلها بالتاكيد \nꪜ*', 1, 'md')
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇انت لست ادمن في المجموعه *\n✓\n", 1, "md") 
end
end,nil)   
end,nil) 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇المجموعه تم تعطيــلها بالتاكيد \nꪜ*', 1, 'md')
VEERBOT:del(VEER_ID.."add:bot:group"..msg.chat_id_, true)  
VEERBOT:del(VEER_ID.."test:group" .. msg.chat_id_)
else
test = '*✔️┇تـم تعطيــل المجموعه بـنجـاح ✓ *\n\nꪜ'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
VEERBOT:del(VEER_ID.."add:bot:group"..msg.chat_id_, true)  
...
local text = '*⚠️┇اهلا بك عزيزي المطور الاساسي '..
...
if VEERBOT:get(VEER_ID..'add:mepr:'..msg.chat_id_) and tonumber(VEERBOT:scard(VEER_ID..'addedtaha:'..msg.sender_user_id_)) == tonumber(VEERBOT:get(VEER_ID..'setadd:'..msg.chat_id_)) then  
VEERBOT:sadd(VEER_ID..'meaddwy:'..msg.chat_id_,msg.sender_user_id_)  
VEERBOT:del(VEER_ID.."addedtaha:"..msg.sender_user_id_)  
VEERBOT:srem(VEER_ID..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
tdcli_function ({
ID = "GetUser",
user_id_ = msg.sender_user_id_
},function(arg,data) 
if data.username_ then
VEER_sendMsg(msg.chat_id_,msg.id_,1,'*📟┇العضو ↫ ❪*[@'..data.username_..']*❫*\n*💠┇قمت باضافه ❪'..tonumber(VEERBOT:get(VEER_ID..'setadd:'..msg.chat_id_))..'❫* اعضاء \n*⚠️┇الان يمكنك الدردشه هنا* \n✓',1,'md')  
else
taha = '📟┇العضو ↫ ❪'..data.id_..'❫\n💠┇قمت باضافه ❪'..tonumber(VEERBOT:get(VEER_ID..'setadd:'..msg.chat_id_))..'❫ اعضاء \n🖲┇الان يمكنك الدردشه هنا \n✓'
VEERmonshn(msg.chat_id_, data.id_, 0, taha, 13, utf8.len(data.id_))  
end
end,nil)
elseif msg.content_.text_ and VEERBOT:get(VEER_ID..'add:mepr:'..msg.chat_id_) and not VEERBOT:sismember(VEER_ID..'meaddwy:'..msg.chat_id_,msg.sender_user_id_) and not VEERBOT:sismember(VEER_ID..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_) then  
if tonumber(VEERBOT:scard(VEER_ID..'addedtaha:'..msg.sender_user_id_)) ~= tonumber(VEERBOT:get(VEER_ID..'setadd:'..msg.chat_id_)) then  
VEERBOT:sadd(VEER_ID..'meaddtaha:'..msg.chat_id_,msg.sender_user_id_)  
...
VEERBOT:sadd(VEER_ID..'addedtaha:'..msg.sender_user_id_,mem_id[i].id_)  
end  
end  
end  
end  
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* عذرا ليست لدي صلاحيه تغير معلومات المجموعه \n', 1, 'md') 
VEERBOT:del(VEER_ID..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) 
else
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الامر *\n✓", 1, "md") 
...
VEER_sendMsg(ch,0, 1, "*⚠️┇* يرجى تفعيل صلاحيات للبوت عندها يمكنك اضافتي\n", 1, 'md')  
return false  end
if data.message_ == "CHANNEL_PRIVATE" then
VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* لا استطيع استخراج معلومات المجموعه  \n", 1, 'md')  
changeChatMemberStatus(ch, bot_id, "Left")
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذا لا يمكنك وضع معرف حسابات في الاشتراك *\n✓', 1, 'md') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذا لا يمكنك وضع معرف مجوعه في الاشتراك *\n✓', 1, 'md') 
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇البوت ادمن في القناة \n✔️┇تم تفعيل الاشتراك الاجباري في *\n*⚠️┇ايدي القناة ('..data.id_..')*\n*⚠️┇معرف القناة *([@'..data.type_.channel_.username_..'])\n✓', 1, 'md') 
VEERBOT:set(VEER_ID..'add:ch:id',data.id_)
VEERBOT:set(VEER_ID..'add:ch:username','@'..data.type_.channel_.username_)
else
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇البوت ليس ادمن في القناة يرجى ترقيته ادمن ثم اعادة المحاوله *\n✓', 1, 'md') 
end
return false  end
end,nil)
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*✔️┇تم تغيير رسالة الاشتراك بنجاح *\n✓', 1, 'md')
end
...
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الاذاعه بالتوجيه للمجموعات *\n✓", 1, "md") 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*✔️┇تم اذاعة الرساله الى ↫ ❪"..gps.."❫ مجموعات في البوت *\n✓", 1, "md")     
VEERBOT:del(VEER_ID.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
if VEERBOT:get(VEER_ID..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_) then 
...
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الاذاعه بالتوجيه للكل *\n✓", 1, "md") 
...
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
VEER_sendMsg(msg.chat_id_,msg.id_ , 1, "*☑️┇تم الغاء الاذاعه بالتوجيه للخاص *\n✓", 1, "md") 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*✔️┇تم اذاعة الرساله الى ↫ ❪"..gps.."❫ مشترك في البوت *\n✓", 1, "md")     
VEERBOT:del(VEER_ID.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
if VEERBOT:get(VEER_ID.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الاذاعه للمجموعات *\n✓", 1, "md") 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*✔️┇تم اذاعة "..whatbc.." الى ↫ ❪"..gps.."❫ مجموعات في البوت *\n✓", 1, "md")     
VEERBOT:del(VEER_ID.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
if VEERBOT:get(VEER_ID.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then  
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الاذاعه للكل *\n✓", 1, "md") 
...
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الاذاعه للمشتركين *\n✓", 1, "md") 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*✔️┇تم اذاعة "..whatbc.." الى ↫ ❪"..gps.."❫ مشترك في البوت *\n✓", 1, "md")     
VEERBOT:del(VEER_ID.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
return false  end 
local rules = msg.content_.text_ VEERBOT:set(VEER_ID.."rules:group" .. msg.chat_id_, rules) VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇*تم حفظ القوانين ✔",  1, "md") end  VEERBOT:del(VEER_ID.."rules" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* تم وضع كليشه ستارت \n', 1, 'md')   
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'\n*⚠️┇* تم وضع الرد في التواصل \n', 1, 'md')  
end
if chat_type == 'user' then
if text == '/start' then  
if is_devtaha(msg) then
local taha = '*⚠️┇اهلا بك عزيزي المطور ✓'..
...
if data.username_ == false then
local text = '👤┇العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n☑️┇بالتاكيد تم الغاء حظره من التواصل\n✓'
VEERBOT:del('numlocktextpv'..bot_id..id_user)    VEERBOT:srem(VEER_ID..'pv:ban'..msg.chat_id_,id_user)
VEERmonshn(msg.chat_id_, id_user, msg.id_, text, 16, utf8.len(CatchName(data.first_name_,15)))  
else
zo = '*👤┇العضــو ↫ ❪ *[@'..data.username_..'] ❫\n*☑️┇بالتاكيد تم الغاء حظره من التواصل\n✓*'
...
if data.username_ == false then
local text = '☑️┇تم ارسال المتحركه \n🖲┇الى ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n✓'
...
if data.username_ == false then
local text = '☑️┇تم ارسال جهة الاتصال \n🖲┇الى ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n✓'
...
if text == 'فتح الكل' and is_devtaha(msg) then   taha = '*☑️┇* تم فتح جميع الاوامر   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      VEERBOT:del(VEER_ID..'lock:photo'..bot_id)    VEERBOT:del(VEER_ID..'lock:vico'..bot_id)    VEERBOT:del(VEER_ID..'lock:ste'..bot_id)    VEERBOT:del(VEER_ID..'lock:file'..bot_id)    VEERBOT:del(VEER_ID..'lock:phon'..bot_id)    VEERBOT:del(VEER_ID..'lock:links'..bot_id)    VEERBOT:del(VEER_ID..'lock:ved'..bot_id)    VEERBOT:del(VEER_ID..'lock:fwd'..bot_id)    VEERBOT:del(VEER_ID..'lock:gif'..bot_id)    VEERBOT:del(VEER_ID..'lock:musec'..bot_id)    end      
if text == 'قفل الكل' and is_devtaha(msg) then   taha = '*⚠️┇* تم قفل جميع الاوامر  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")      VEERBOT:set(VEER_ID..'lock:photo'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:vico'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:ste'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:file'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:phon'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:links'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:ved'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:fwd'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:gif'..bot_id,true)    VEERBOT:set(VEER_ID..'lock:musec'..bot_id,true)     end   
if text == 'فتح الصور' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الصور   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:photo'..bot_id) end  
if text == 'قفل الصور' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الصور  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:photo'..bot_id,true) end 
if text == 'فتح الصوت' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الصوت   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:vico'..bot_id) end  
if text == 'قفل الصوت' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الصوت  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:vico'..bot_id,true) end 
if text == 'فتح الاغاني' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الاغاني   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:musec'..bot_id) end  
if text == 'قفل الاغاني' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الاغاني  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:musec'..bot_id,true) end 
if text == 'فتح المتحركه' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح المتحركه   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:gif'..bot_id) end  
if text == 'قفل المتحركه' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل المتحركه  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:gif'..bot_id,true) end 
if text == 'فتح التوجيه' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح التوجيه   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:fwd'..bot_id) end  
if text == 'قفل التوجيه' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل التوحيه  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:fwd'..bot_id,true) end 
if text == 'فتح الفيديو' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الفيديو   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:ved'..bot_id) end  
if text == 'قفل الفيديو' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الفيديو  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:ved'..bot_id,true) end 
if text == 'فتح الروابط' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الروابط   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:links'..bot_id) end  
if text == 'قفل الروابط' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الروابط  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:links'..bot_id,true) end 
if text == 'فتح الجهات' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الجهات   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:phon'..bot_id) end  
if text == 'قفل الجهات' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الجهات  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:phon'..bot_id,true) end 
if text == 'فتح الملفات' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الملفات   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:file'..bot_id) end  
if text == 'قفل الملفات' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الملفات  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:file'..bot_id,true) end 
if text == 'فتح الملصقات' and is_devtaha(msg) then  taha = '*☑️┇* تم فتح الملصقات   ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:del(VEER_ID..'lock:ste'..bot_id) end  
if text == 'قفل الملصقات' and is_devtaha(msg) then  taha = '*⚠️┇* تم قفل الملصقات  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md")  VEERBOT:set(VEER_ID..'lock:ste'..bot_id,true) end 
if text == 'الاعدادات 🔏' and is_devtaha(msg) then  if VEERBOT:get(VEER_ID..'lock:photo'..bot_id) then    lock_photo = '* مقفل ✓ *'      else     lock_photo = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:vico'..bot_id) then    lockvic = '* مقفل ✓ *'      else     lockvic = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:ste'..bot_id) then    lockste = '* مقفل ✓ *'      else     lockste = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:file'..bot_id) then    lockfile = '* مقفل ✓ *'     else     lockfile = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:phon'..bot_id) then    lockphon = '* مقفل ✓ *'      else     lockphon = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:links'..bot_id) then    lock_link = '* مقفل ✓ *'      else     lock_link = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:ved'..bot_id) then    lock_vid = '* مقفل ✓ *'      else     lock_vid = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:fwd'..bot_id) then    lock_fwd = '* مقفل ✓ *'      else     lock_fwd = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:gif'..bot_id) then    lock_gif = '* مقفل ✓ *'      else     lock_gif = '*مفتوح ✘*'    end    if VEERBOT:get(VEER_ID..'lock:musec'..bot_id) then    lock_muse = '* مقفل ✓ *'      else     lock_muse = '*مفتوح ✘*'    end    local text = '*⚠️┇* اهلا بك في اعدادات الخاص ✓'..'\n*ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ*\n'..    '\n*📟┇* الروابط '..lock_link..    '\n'..'*📟┇* الصور '..lock_photo..    '\n'..'*📟┇* الاغاني '..lockvic..    '\n'..'*📟┇* الملصقات '..lockste..    '\n'..'*📟┇* الملفات '..lockfile..    '\n'..'*📟┇* الجهات '..lockphon..    '\n'..'*📟┇* الفيديو '..lock_vid..    '\n'..'*📟┇* التوجيه '..lock_fwd..    '\n'..'*📟┇* المتحركه '..lock_gif..    '\n'..'*📟┇* الصوت '..lock_muse..    '\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🚨*┇* اضافه الى ذالك تستطيع قفل وفتح الكل\n🚸*┇* قفل الكل \n🚸*┇* فتح الكل'    VEER_sendMsg(msg.chat_id_, msg.id_, 1, text, 1, 'md')     end     
...
if text == 'مسح المحظورين 📢' and is_devtaha(msg) then       local list = VEERBOT:smembers(VEER_ID..'pv:ban'..msg.chat_id_)   for k,v in pairs(list) do     VEERBOT:del(VEER_ID..'pv:ban'..msg.chat_id_)   VEERBOT:del('numlocktextpv'..bot_id..v)  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'⚠️*┇* تم مسح المحظورين', 1, 'md')     end
if text == 'تفعيل البوت الخدمي 🎮' and is_devtaha(msg) then local  taha = '*⚠️┇*تم تفعيل البوت خدمي  ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:del(VEER_ID..'lock:bot:free'..bot_id) end 
if text == 'تعطيل البوت الخدمي 🚸' and is_devtaha(msg) then taha = '*⚠️┇*تم تعطيل البوت الخدمي  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:set(VEER_ID..'lock:bot:free'..bot_id,true) end
if text == 'تفعيل تواصل 📨' and is_devtaha(msg) then local  taha = '*⚠️┇*تم تفعيل بوت التواصل  ✔' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:del(VEER_ID..'lock:botl'..bot_id) end 
if text == 'تعطيل تواصل 📩' and is_devtaha(msg) then taha = '*⚠️┇*تم تعطيل التواصل  ❌' VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") VEERBOT:set(VEER_ID..'lock:botl'..bot_id,true) end
if text == 'تحديث ♻' and is_devtaha(msg) then  local filed = io.popen('ls plugins_'):lines() for files in filed do if files:match(".lua$") then end end dofile('VEER.lua') load_plugins() io.popen("rm -rf ~/.telegram-cli/data/audio/*") io.popen("rm -rf ~/.telegram-cli/data/document/*") io.popen("rm -rf ~/.telegram-cli/data/photo/*") io.popen("rm -rf ~/.telegram-cli/data/sticker/*") io.popen("rm -rf ~/.telegram-cli/data/temp/*") io.popen("rm -rf ~/.telegram-cli/data/thumb/*") io.popen("rm -rf ~/.telegram-cli/data/video/*") io.popen("rm -rf ~/.telegram-cli/data/voice/*") io.popen("rm -rf ~/.telegram-cli/data/profile_photo/*")   VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* تم تحديث البوت', 1, 'md') end 
if text == "وضع اسم البوت ⚡" and is_devtaha(msg) then VEERBOT:setex(VEER_ID..'namebot:witting'..msg.sender_user_id_,300,true) VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي الاسم 📯\n",1, 'md')  end
if text == 'مسح المميزين عام 🌟' and is_devtaha(msg) then      local list = VEERBOT:smembers(VEER_ID..'vip:groups')    if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد مميزين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    VEERBOT:srem(VEER_ID.."vip:groups",v)    num = num + 1  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*☑️┇تم مسح {'..num..'} من المميزين عام *\n', 1, 'md')   end
if text == 'مسح المطورين 👮' and is_devtaha(msg) then     local list = VEERBOT:smembers(VEER_ID..'sudo:bot')    if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد مطورين ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    VEERBOT:srem(VEER_ID.."sudo:bot",v)    num = num + 1  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*??┇تم مسح {'..num..'} من المطورين *\n', 1, 'md')   end
if text == 'مسح قائمه العام 🚷' and is_devtaha(msg) then   local list = VEERBOT:smembers(VEER_ID..'VEER:gbaned')    if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md')   return false  end  local num = 0  for k,v in pairs(list) do    VEERBOT:srem(VEER_ID.."VEER:gbaned",v)    num = num + 1  end   VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*☑️┇تم مسح {'..num..'} من المحظورين عام *\n', 1, 'md')   end
if text and text:match("^ضع رد تواصل 💻$") and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."sudo:pv" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'📟*┇* ارسل لي النص الذي تريده ', 1, 'md') end 
if text and text:match("^ضع كليشه المطور 🎐$") and is_devtaha(msg) then VEERBOT:setex(VEER_ID.."sudo:dev" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'📟*┇* ارسل لي النص الذي تريده ', 1, 'md') end 
...
if text=="اذاعه بالتوجيه 📟" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."bc:in:gropsfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي التوجيه ليتم اذاعته للمجموعات\n✓", 1, "md")   end
if text=="اذاعه خاص بالتوجيه 🔖" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."bc:in:pvfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي التوجيه ليتم اذاعته للخاص\n✓", 1, "md")   end
if text=="اذاعه عام بالتوجيه 💾" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."bc:in:allfwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي التوجيه ليتم اذاعته للكل\n✓", 1, "md")   end
if text=="اذاعه 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."bc:in:grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي سواء كان ↫ ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى المجموعات\n✓", 1, "md")   end
if text=="اذاعه للكل 📡" and msg.reply_to_message_id_ == 0  and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."bc:in:all" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي سواء كان ↫ ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الكل\n✓", 1, "md")   end
if text=="اذاعه خاص 📡" and msg.reply_to_message_id_ == 0 and is_devtaha(msg) then   VEERBOT:setex(VEER_ID.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true)   VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي سواء كان ↫ ❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الخاص\n✓", 1, "md")   end 
if text ==('المجموعات 📇') and is_devtaha(msg) then    local list = VEERBOT:smembers(VEER_ID..'bot:gpsby:id')   if #list == 0 then  VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*📟┇لا توجد مجموعات حاليا *\n', 1, 'md')  return false  end local t = '⚡┇* اهلا بك في ايدي المجموعات 🍁*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'    for k,v in pairs(list) do     local nummsg = tonumber(VEERBOT:get(VEER_ID..'groupmsg:'..v..':'))   numrgroup(v) local numg = (VEERBOT:get(VEER_ID.."numgrop"..v) or '3')  local namechat = VEERBOT:get(VEER_ID..'group:name'..v)   if namechat then  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n*« "..namechat..' ↫ ❪'..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     else  t = t..'*'..k.."➛* `"..v.."` "..tfgroup(nummsg).."\n* ❪"..numg..'❫*\n*ٴ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃*\n'     end  file = io.open("VEER_groups", "w") file:write([[ ]]..isnothtml(t)..[[ ]]) file:close()   end    t = t..'*⚠️┇*لعرض معلومات مجموعه معينه\n*📟┇ارسل كشف من ثم ايدي المجموعه*\n*🚸┇مثال ❪كشف -10012345667❫*\n꞉'    if #list >= 25 then    local groups = VEERBOT:scard(VEER_ID..'bot:gpsby:id')    sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './VEER_groups','⚠️┇عذرا لديك الكثير من المجموعات\n☑️┇تم ارسال المجموعات في الملف\n🚸┇عدد المجموعات •⊱'..groups..'⊰•',dl_cb, nil)   else   VEER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')    end   end
...
if test == 'repp' then   
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم تغير كليشه الترحيب 💯*\n", 1, 'md')   
VEERBOT:del("addreply1:"..msg.sender_user_id_..bot_id)   
...
local taha = VEERBOT:scard(VEER_ID.."rep:media"..msg.chat_id_)  
for k,v in pairs(list) do  
...
VEERBOT:del(VEER_ID.."taha:"..v..msg.chat_id_)  
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* المجموعه تحتوي على *{"..taha.."}* رد \n*⚠️┇* تم مسح الردود جميعها \n", 1, 'md')  
end
if  text == "قائمه الردود بالرد" and is_monsh(msg) then  
local list = VEERBOT:smembers(VEER_ID.."rep:media"..msg.chat_id_)  
t = "*⚠️┇قائمة ردود المجموعه بالرد ✓\n➖➖➖➖➖➖➖➖➖*\n"    
for k,v in pairs(list) do  
...
taha = 'ملصق 🃏'
elseif VEERBOT:get(VEER_ID.."taha:"..v..msg.chat_id_) then
taha = 'رساله 💭'
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇لقد تم اضافة رد بهاذه الكلمه \n📟┇ارسل كلمه اخرى او ارسل الغاء*\n✓\n", 1, 'md')  
else
...
VEERBOT:del("taha:"..text..msg.chat_id_)  
...
VEERBOT:del(VEER_ID.."taha:"..text..msg.chat_id_)  
...
if text then   
VEERBOT:set(VEER_ID.."taha:"..test..msg.chat_id_, text)  
end  
...
local taha = VEERBOT:get(VEER_ID.."taha:"..text..msg.chat_id_)   
...
local taha = VEERBOT:scard(VEER_ID.."repmedia"..msg.chat_id_)  
for k,v in pairs(list) do  
...
local taha = VEERBOT:get(VEER_ID.."add:reply:rd"..text..msg.chat_id_)   
...
local taha = VEERBOT:get(VEER_ID.."add:rep:text:all:rd"..text..bot_id)    
...
local taha = VEERBOT:get(VEER_ID.."add:rep:text:all"..text..bot_id)    
...
if text ==('ايديي') then   
VEER_sendMsg(msg.chat_id_, msg.id_,  1, '*⚠️┇اضغط على الايدي ليتم نسخه ➘*\n\n*📟┇الايدي ◂⊱ *`'..msg.sender_user_id_..'` *⊰▸*\n✓', 1, 'md')   
end
...
if #group == i then 
if (w + q) == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇لا يوجد مجموعات وهميه في البوت* \n✓', 1, 'md')   
else
local taha = (w + q)
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇عدد المجموعات الان ↫ ❪ '..#group..' ❫*'..VEER..''..taha..'\n*📡┇الان عدد المجموعات الحقيقي ↫ ❪ '..sendok..' ❫ مجموعات*\n✓', 1, 'md')   
end
end
end,nil)
end
...
if #pv == i then 
if sendok == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇لا يوجد مشتركين وهميين في البوت* \n✓', 1, 'md')   
else
local ok = #pv - sendok
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇عدد المشتركين الان ↫ ❪ '..#pv..' ❫*\n*☑️┇تم ازالة ↫ ❪ '..sendok..' ❫ من المشتركين*\n*📡┇الان عدد المشتركين الحقيقي ↫ ❪ '..ok..' ❫ مشترك*\n✓', 1, 'md')   
end
end
end,nil)
end,nil)
...
VEERBOT:set(VEER_ID..'id:gp'..msg.chat_id_,taha)  
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'✔️*┇تم مسح {'..pv..'} من المقيدين*\n', 1, 'md')   
end
end
...
local ac = 'قناة'
local chan = '*⚠️┇نوع الحساب ↫ ❪ '..ac..' ❫\n📟┇الايدي ↫ ❪*`'..kk.id_..'`*❫\n🎫┇المعرف ↫ ❪* [@'..username..'] *❫\n📟┇الاسم ↫ ❪ *`'..kk.title_..'`* ❫*'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,chan, 1, 'md')
else
local aac = 'مجموعه'
local chanb = '*⚠️┇نوع الحساب ↫ ❪ '..aac..' ❫\n📟┇الايدي ↫ ❪*`'..kk.id_..'`*❫\n🎫┇المعرف ↫ ❪* [@'..username..'] *❫\n📟┇الاسم ↫ ❪ *`'..kk.title_..'`* ❫*'
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*🖲٠┇عدد المشتركين في البوت ↫ ❪ '..addgrop..' ❫*\n✓', 1, 'md')    
end      
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* حسناا ارسل لي رابط المجموعه ", 1, 'md')       
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* لا يوجد رابط المجموعه\n*📟┇ارسل ↫ ❪ ضع رابط ❫ لوضع رابط المجموعه*\n✓', 1, 'md')              
end            
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي التوجيه ليتم اذاعته للمجموعات\n✓", 1, "md") 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي التوجيه ليتم اذاعته للخاص\n✓", 1, "md") 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي التوجيه ليتم اذاعته للكل\n✓", 1, "md") 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي سواء كان ↫❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى المجموعات\n✓", 1, "md") 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي سواء كان ↫❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الكل\n✓", 1, "md") 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* ارسل لي سواء كان ↫❪ رساله , صوره , متحركه , ملصق  ❫ للاذاعه الى الخاص\n✓", 1, "md") 
end 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* لا يوجد قوانين هنا \n✓",  1, "md")   
end    
end
...
if text ==('طرد الاعضاء') and is_monsh(msg) then local function Members(extra, result) if not msg.can_be_deleted_ == true then VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*🚨 ┇* تنبيــه انا لست ادمن يرجى ترقيتي ادمن هنا 👮\n", 1, "md") else for k,v in pairs(result.members_) do local function cleanMembers(extra, result) if not result.first_name_ then changeChatMemberStatus(msg.chat_id_, result.id_, "Kicked") end end getUser(v.user_id_, cleanMembers, nil) end VEER_sendMsg(msg.chat_id_, msg.id_, 0,'🗑* ┇* تم مسح الحسابات المحذوفه', 1, 'md') end end tdcli_function ({ID = "GetChannelMembers",channel_id_ = getChatId(msg.chat_id_).ID,offset_ = 0,limit_ = 1000}, Members, nil) end
if is_mod(msg) then 
...
taha = "*✔️┇تم تعطيل الاشتراك الاجباري *\n✓"
VEER_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
if text == "الاشتراك الاجباري" and is_devtaha(msg) then  
if VEERBOT:get(VEER_ID..'add:ch:username') then
local addchusername = VEERBOT:get(VEER_ID..'add:ch:username')
taha = "*✔️┇تم تفعيل الاشتراك الاجباري \n🖲┇على القناة ↫ *["..addchusername.."]\n✓"
VEER_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
else
taha = "*⚠️┇لا يوجد قناة في الاشتراك الاجباري *\n✓"
VEER_sendMsg(msg.chat_id_, msg.id_, 1,taha, 1, 'md') 
end
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا تستطيع رفع القناة في البوت *\n✓', 1, 'md') 
return false  end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا استطيع استخراج معلوماته*\n✓', 1, 'md') 
return false  end
if data and data.type_ and data.type_.ID == "UserTypeBot" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا تستطيع رفع وتنزيل البوتات *\n✓', 1, 'md') 
return false  end
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا تستطيع تنزيل القناة في البوت *\n✓', 1, 'md') 
return false  end
if result and result.type_ and result.type_.user_ and result.type_.user_.type_ and result.type_.user_.type_.ID == "UserTypeBot" then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا تستطيع رفع وتنزيل البوتات *\n??', 1, 'md') 
return false  end
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد مكتومين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد محظورين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد مميزين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد ادمنيه ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد مدراء ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد منشئين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد مطورين ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد محظورين عام ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت وليس لدي قيود * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇هاذا المعرف قناة وليس معرف حساب *\n✓', 1, 'md') 
return false  end
if tonumber(result.id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت وليس لدي قيود * \n', 1, 'md')  
return false  end 
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت ولست محظور * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇يرجى تفعيل صلاحيه حظر المستخدمين لاتمكن من الغاء حظره *\n✓', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 3 then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا لست ادمن في المجموعه *\n✓', 1, 'md') 
return false  end
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا تستطيع حظر القناة *\n✓', 1, 'md') 
return false  end
if tonumber(result.id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت ولست محظور * \n', 1, 'md')  
return false  end 
...
local list = VEERBOT:smembers(VEER_ID..'VEER:baned'..msg.chat_id_)
local t = '*⚠️┇قائمه محظورين المجموعه *\n*➖➖➖➖➖➖➖➖➖*\n' 
for k, v in pairs(list) do 
...
local list = VEERBOT:smembers(VEER_ID..'vip:group'..msg.chat_id_)
local t = '*⚠️┇قائمه مميزين المجموعه *\n*➖➖➖➖➖➖➖➖➖*\n' 
for k, v in pairs(list) do 
local taha = VEERBOT:get(VEER_ID.."user:Name" .. v)
if taha then
local username = taha
...
local list = VEERBOT:smembers(VEER_ID..'mutes'..msg.chat_id_)
local t = '*⚠️┇قائمه مكتومين المجموعه *\n*➖➖➖➖➖➖➖➖➖*\n' 
for k, v in pairs(list) do 
local taha = VEERBOT:get(VEER_ID.."user:Name" .. v)
if taha then
local username = taha
...
local list = VEERBOT:smembers(VEER_ID..'tedmembars'..msg.chat_id_)
local t = '*⚠️┇قائمه مقيدين المجموعه *\n*➖➖➖➖➖➖➖➖➖*\n' 
for k, v in pairs(list) do 
local taha = VEERBOT:get(VEER_ID.."user:Name" .. v)
if taha then
local username = taha
...
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لأ أستطيع حظر نفسي * ', 1, 'md')  
return false  end 
if VEER1(msg.chat_id_,result.sender_user_id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع حظر ↫ ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
if data.username_ == false then
zo = '👤┇العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n✔️┇بالتاكيد تـم حظره عام من الكروبات\n✓'   
VEERmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
VEERBOT:sadd(VEER_ID..'VEER:gbaned',result.sender_user_id_)   
local list = VEERBOT:smembers(VEER_ID..'bot:gpsby:id')  for k,v in pairs(list) do  kick(msg,v,result.sender_user_id_) end
else
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع حظر ↫ ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع حظر ↫ ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "CHAT_ADMIN_REQUIRED" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇يرجى تفعيل صلاحيه حظر المستخدمين لاتمكن من الغاء حظره عام *\n✓', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 3 then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا لست ادمن في المجموعه *\n✓', 1, 'md') 
return false  end
...
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لأ أستطيع كتم نفسي * ', 1, 'md')  
return false  end 
if VEER1(msg.chat_id_,result.sender_user_id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع كتم ↫ ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
if msg.can_be_deleted_ == false then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* انا لست ادمن يرجى رفعي والمحاوله مره اخره\n", 1, "md") 
return false  end 
function promreply(extra,result,success) 
if result and result.message_ and result.message_ == "USERNAME_NOT_OCCUPIED" then 
local taha = '*🎫┇المعرف لا يوجد فيه حساب *'
...
return false  end 
if VEER1(msg.chat_id_,result.id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع كتم ↫ ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
...
return false  end 
if VEER1(msg.chat_id_,user) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع كتم ↫ ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا استطيع كتم ادمنية المجموعه *\n✓', 1, 'md') 
return false  end
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت ولست مكتوم * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع الحظر لقد تم تعطيل { الحظر - الطرد } \n👨🏻‍✈️*")   
return false  end 
if VEERBOT:sismember(VEER_ID..'LOCK:BAN'..msg.chat_id_,msg.sender_user_id_) then
VEER_send(msg.chat_id_,msg.id_,"*✔️┇تم وضع القيود عليك لا تستطيع { طرد او حظر } المستخدمين \n👨🏻‍✈️*")   
return false  end 
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لأ أستطيع حظر نفسي * ', 1, 'md')  
...
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "USER_ADMIN_INVALID" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا استطيع حظر ادمنية المجموعه *\n✓', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "CHAT_ADMIN_REQUIRED" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇ليس لدي صلاحية حظر المستخدمين *\n✓', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 3 then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا لست ادمن في المجموعه *\n✓', 1, 'md') 
return false  end
...
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇انت لست ادمن \n👨🏻‍✈️*")   
end
end
...
return false  end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا تستطيع طرد القناة *\n✓', 1, 'md') 
return false  end
if tonumber(result.id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لأ أستطيع طرد نفسي * \n', 1, 'md')  
return false  end 
...
zo = '*👤┇* العضــو ↫ ❪ [@'..username..'] ❫\n*🎫┇الايـدي ↫ ❪* `'..result.id_..'` ❫\n*☑️┇* بالتاكيد تـم طرده من الكروب\n✓'     
VEERBOT:set(VEER_ID.."user:Name"..result.id_,"@"..username)
VEER_sendMsg(msg.chat_id_, msg.id_, 1, zo, 1, 'md') 
return false  end
if VEER1(msg.chat_id_,result.id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع طرد ↫ ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" }, 
},function(arg,ban) 
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "USER_ADMIN_INVALID" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا استطيع طرد ادمنية المجموعه *\n✓', 1, 'md') 
return false  end
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "CHAT_ADMIN_REQUIRED" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇ليس لدي صلاحية حظر المستخدمين *\n✓', 1, 'md') 
return false  end
...
return false  end 
if VEER1(msg.chat_id_,result.sender_user_id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع طرد ↫ ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = result.sender_user_id_},function(arg,da) 
tdcli_function ({
ID = "GetUser",
...
return false  end 
if VEER1(msg.chat_id_,user) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع طرد ↫ ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
...
function prom_reply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لأ أستطيع تقييد نفسي * ', 1, 'md')  
return false  end 
if VEER1(msg.chat_id_,result.sender_user_id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع تقييد ↫ ❪ '..get_mokforkick(msg.chat_id_,result.sender_user_id_)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
if data.username_ == false then
zo = '👤┇العضــو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n✔️┇بالتاكيد تـم تقييده من الكروب\n✓'   
VEERmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
HTTPS.request("https://api.telegram.org/bot" .. chaneel .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.."") 
VEERBOT:sadd(VEER_ID..'tedmembars'..msg.chat_id_,result.sender_user_id_) 
else
...
return false  end 
if VEER1(msg.chat_id_,result.id_) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع تقييد ↫ ❪ '..get_mokforkick(msg.chat_id_,result.id_)..' ❫ *\n', 1, 'md') 
return false  end 
...
return false  end 
if VEER1(msg.chat_id_,user) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇عذرآ لآ أستطيع تقييد ↫ ❪ '..get_mokforkick(msg.chat_id_,user)..' ❫ *\n', 1, 'md') 
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
if ban and ban.code_ and ban.code_ == 400 and ban.message_ == "USER_ADMIN_INVALID" then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇لا استطيع تقييد ادمنية المجموعه *\n✓', 1, 'md') 
return false  end
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت ولست مقييد * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = result.sender_user_id_
...
local user = user1 or user2
if tonumber(user) == tonumber(bot_id) then  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇انا البوت ولست مقيد * \n', 1, 'md')  
return false  end 
tdcli_function ({
ID = "GetUser",
user_id_ = user
...
tdcli_function ({ID="DeleteMessages", chat_id_=msg.chat_id_,  message_ids_={[0] = tonumber(msg.reply_to_message_id_),msg.id_} },function(arg,data)  if data.code_ == 6 then VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* انا لست ادمن او ليست لدي صلاحيه حذف الرسائل \n✓", 1, 'md')   return false  end  end,nil) 
end	 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇الكلمه ↫ ❪ '..taha..' ❫*\n*📪┇* بالتأكيد تم منع هاذه الكلمه \n✓', 1, 'md') 
else
...
VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* التثبيت مقفل في المجموعه \n✓", 1, 'md')  
return false  end
if VEERBOT:sismember(VEER_ID..'LOCK:PINMSG'..msg.chat_id_,msg.sender_user_id_) then
VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* تم منعك من التثبيت هنا لا تستطيع التثبيت \n✓", 1, 'md')  
return false  end
local id = msg.id_ 
local msgs = {[0] = id}  
tdcli_function ({
...
VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* بالتاكيد تم تثبيت الرساله \n✓", 1, 'md')  
elseif data.code_ == 6 then
VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* لا استطيع تثبيت الرساله انا لست ادمن \n✘", 1, 'md')  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
VEER_sendMsg(msg.chat_id_,msg.id_, 1, "*⚠️┇* ليس لدي صلاحيه لتثبيت الرسائل \n✘", 1, 'md')  
else
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*⚠️┇* لا استطيع الطرد انا لست ادمن هنا \n✓", 1, "md") 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* عذرا انت ❪ '..get_mok(msg.chat_id_,msg.sender_user_id_)..' ❫ لا استطيع طردك \n✓', 1, 'md') 
VEERBOT:del(VEER_ID..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
return false  end  
...
kick(msg,msg.chat_id_,msg.sender_user_id_)  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* تم طردك من هنا \n✓', 1, 'md') 
end 
VEERBOT:del(VEER_ID..'kick:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
end 
end
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* انت من ضمن ❪ '..get_mok2(msg.chat_id_,msg.sender_user_id_)..' ❫ ليس من صلاحياتي تنزيلك \n⭐', 1, 'md') 
VEERBOT:del(VEER_ID..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else  
if not is_memar(msg)  then  
VEERBOT:del(VEER_ID..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true) 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* انت هنا لست سواء عضو ليس لديك رتبه في البوت\n✓', 1, 'md') 
VEERBOT:del(VEER_ID..'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_, true)  
else 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1, '*⚠️┇* لن يتم تنزيلك ستبقى ضمن ❪ '..t..' ❫\n✓', 1, 'md') 
end 
end 
local hash = 'demrtpa:'..msg.chat_id_..':'..msg.sender_user_id_ 
if VEERBOT:get(VEER_ID..hash) then 
...
VEERBOT:del(VEER_ID..'meaddtaha:'..msg.chat_id_) 
local taha = VEERBOT:keys("addedtaha:*") 
for i=1,#taha do VEERBOT:del(VEER_ID..taha[i]) 
end 
...
local taha = '*⚠️┇اهلا بك في معلومات المجموعه*\n➖➖➖➖➖➖➖➖➖\n*'..
'👨🏻‍✈️┇* عدد الادمنيه ↫ *❪ '..data.administrator_count_..
' ❫*\n*🚯┇* عدد المطرودين ↫ *❪ '..data.kicked_count_..
' ❫*\n*🙋🏻‍♂┇* عدد الاعضاء ↫ *❪ '..data.member_count_..
' ❫*\n*📨┇* عدد الرسائل ↫ *❪ '..(nummsgg)..
...
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
VEER_sendMsg(result.chat_id_, result.id_, 1, '*⚠️┇* عذرا ليست لدي صلاحيه تغير معلومات المجموعه \n', 1, 'md') 
else
...
taha = '*✔️┇تم تعطيل الايدي بالصوره *\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
taha = '*✔️┇تم تفعيل كليشه الترحيب عند الاضافه*\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
taha = '*✔️┇تم تعطيل كليشه الترحيب عند الاضافه*\n✓' 
VEER_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
...
local msgtaha = 500 
local msggstaha = VEERBOT:get(VEER_ID..'user:messages:'..msg.chat_id_..':'..msg.sender_user_id_) or 0  
...
elseif is_mod(msg) then 
t = VEERBOT:get(VEER_ID.."Comd:New:rt:user:"..msg.chat_id_..msg.sender_user_id_) or 'الادمن 💐' 
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,  '*✔️┇تم مسح كليشه الايدي *\n', 1, 'md')
return false  
end 
...
VEERBOT:set(VEER_ID.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
VEERBOT:setex(VEER_ID.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📟┇ارسل نوع الرتبه {مدير - ادمن - مميز - عضو}*\n✓", 1, "md") 
end
if text and text:match('مسح صلاحيه (.*)') and is_vipgroup(msg) then 
ComdNew = text:match('مسح صلاحيه (.*)')
VEERBOT:del(VEER_ID.."Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم مسح الصلاحيه *\n✓", 1, "md") 
end
if VEERBOT:get(VEER_ID.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم الغاء الامر *\n✓", 1, "md") 
VEERBOT:del(VEER_ID.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == 'مدير' then
if not is_owner(msg) then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📟┇تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n📥┇ارسل الصلاحيه مجددا*\n", 1, "md") 
return false
end
end
if text == 'ادمن' then
if not is_monsh(msg) then 
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📟┇تستطيع اضافه صلاحيات {مميز - عضو} \n📥┇ارسل الصلاحيه مجددا*\n", 1, "md") 
return false
end
end
if text == 'مميز' then
if not is_mod(msg) then
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*📟┇تستطيع اضافه صلاحيات {عضو} \n📥┇ارسل الصلاحيه مجددا*\n", 1, "md") 
return false
end
end
if text == 'مدير' or text == 'ادمن' or text == 'مميز' or text == 'عضو' then
local textn = VEERBOT:get(VEER_ID.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
VEERBOT:set(VEER_ID.."Comd:New:rt:bot:"..textn..msg.chat_id_,text)
VEER_sendMsg(msg.chat_id_, msg.id_, 1, "*☑️┇تم اضافه الامر *\n✓", 1, "md") 
VEERBOT:del(VEER_ID.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
VEERBOT:set(VEER_ID.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA) 
VEERBOT:sadd(VEER_ID..'vip:group'..msg.chat_id_,result.sender_user_id_)  
elseif VEERrt == 'ادمن' and is_monsh(msg) then 
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم رفعه ('..RTPA..') هنا\n',result.sender_user_id_)   
VEERBOT:set(VEER_ID.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA)
VEERBOT:sadd(VEER_ID..'mods:'..msg.chat_id_,result.sender_user_id_)  
elseif VEERrt == 'مدير' and is_owner(msg) then
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم رفعه ('..RTPA..') هنا\n',result.sender_user_id_) 
VEERBOT:set(VEER_ID.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA)  
VEERBOT:sadd(VEER_ID..'modergroup'..msg.chat_id_,result.sender_user_id_)  
elseif VEERrt == 'عضو' and is_vipgroup(msg) then
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم رفعه ('..RTPA..') هنا\n',result.sender_user_id_)   
end
end,nil)   
end   
...
local VEERrt = VEERBOT:get(VEER_ID.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if VEERrt == 'مميز' and is_mod(msg) then
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n☑️┇تم رفعه ('..text1[1]..') هنا\n',result.id_)   
VEERBOT:sadd(VEER_ID..'vip:group'..msg.chat_id_,result.sender_user_id_)  
VEERBOT:set(VEER_ID.."Comd:New:rt:user:"..msg.chat_id_..result.id_,text1[1])
elseif VEERrt == 'ادمن' and is_monsh(msg) then 
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(result.type_.user_.first_name_)..'}'..'\n☑️┇تم رفعه ('..text1[1]..') هنا\n',result.id_)   
VEERBOT:sadd(VEER_ID..'mods:'..msg.chat_id_,result.sender_user_id_)  
VEERBOT:set(VEER_ID.."Comd:New:rt:user:"..msg.chat_id_..result.id_,text1[1])
...
info = '📌| المعرف غلط'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
end
...
function by_reply(extra, result, success)   
if not msg.can_be_deleted_ == true then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇انا لست ادمن هنا يرجى ترقيتي \n👨🏻‍✈️*")   
return false 
end      
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال التثبيت \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
return false  
end    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = result.sender_user_id_},function(arg,da) 
...
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇هذا مجرد عضو هنا\n👨🏻‍✈️*")   
end
end
end,nil)   
end,nil)
...
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا استطيع منع القنواة\n👨🏻‍✈️*")   
return false 
end      
if not msg.can_be_deleted_ == true then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇انا لست ادمن هنا يرجى ترقيتي \n👨🏻‍✈️*")   
...
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇هذا مجرد عضو \n👨🏻‍✈️*")   
end
end
end,nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الملصقات \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال الملصقات هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الصور \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الاونلاين \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*??┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال الاونلاين هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال التوجيه \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال التوجيه هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الروابط \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n??🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال الروابط هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال السيلفي \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال السيلفي هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الصوت \n👨??‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الفيديو \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال الفيديو هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال الماركداون \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال الماركداون هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال المتحركه \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال المتحركه هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من ارسال المعرفات \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ارسال المعرفات هنا\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇لا تستطيع منعي من { طرد - حظر } المستخدمين \n👨🏻‍✈️*")   
return false  
end   
if getrtp(msg.chat_id_,result.sender_user_id_) then   
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇عذرا لا تستطيع منع ↫ { المنشئين والمطورين } \n👨🏻‍✈️*")   
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منعه من ↫ ( طرد - حظر ) المستخدمين\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n📟┇☑️┇تم الغاء منعه من ( طرد - حظر ) المستخدمين \n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇انا بوت استطيع طرد - حظر المستخدمين \n👨🏻‍✈️*")   
return false  
end   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
VEERBOT:sadd(VEER_ID..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم منحه صلاحية ( طرد - حظر ) المستخدمين \n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if tonumber(result.sender_user_id_) == tonumber(bot_id) then    
VEER_send(msg.chat_id_,msg.id_,"*⚠️┇انا بوت لا تستطيع منعي من الحظر - الطرد \n👨🏻‍✈️*")   
return false  
end   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
VEERBOT:srem(VEER_ID..'SET:BAN'..msg.chat_id_,result.sender_user_id_)     
sendMention(msg,msg.chat_id_,'👤┇العضو ↫ {'..CatchNamertprtp(data.first_name_)..'}'..'\n☑️┇تم الغاء منحه صلاحية ( طرد - حظر ) المستخدمين\n',result.sender_user_id_)   
end,nil)   
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, by_reply, nil)
end
...
if #list == 0 then
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*⚠️┇* لا يوجد اعضاء لديهم صلاحياة الحظر ليتم مسحهم\n', 1, 'md') 
return false  end
local num = 0
for k,v in pairs(list) do  
...
VEER_sendMsg(msg.chat_id_, msg.id_, 1,'*☑️┇تم مسح {'..num..'} من الذين لديهم صلاحيات الحظر *\n', 1, 'md') 
end
if text == 'صلاحيات الحظر' and is_owner(msg) then 
local list = VEERBOT:smembers(VEER_ID..'SET:BAN'..msg.chat_id_)
local t = '*⚠️┇قائمه اصحاب صلاحية الحظر *\n*➖➖➖➖➖➖➖➖➖*\n' 
for k, v in pairs(list) do 
local taha = VEERBOT:get(VEER_ID.."user:Name" .. v)
if taha then
local username = taha
...
taha = '\n*💈┇اهلا عزيزي المطور *\n➖➖➖➖➖➖➖➖➖'..
'\n*⚠️┇لقد تم طردي من مجموعه جديده *'..
'\n*🔖┇* معلومات المجموعه '..
'\n*📟┇* الايدي ↫ ❪`'..data.id_..'`❫'..
'\n*⚜┇* الاسم ↫ ❪'..link..'❫'..
'\n*✔️┇* تم مسح بيانات المجموعه وتم ازالتها من المجموعات\n✓' 
...
if not filess then
os.execute('cd requfiles ;wget https://raw.githubusercontent.com/TYTBOT/VEER/master/requfiles/JSON.lua') 
dofile('VEER.lua')  
end
local filess = io.open("requfiles/dkjson.lua","r")
if not filess then
os.execute('cd requfiles ;wget https://raw.githubusercontent.com/TYTBOT/VEER/master/requfiles/dkjson.lua') 
dofile('VEER.lua')  
end
local filess = io.open("requfiles/serpent.lua","r")
if not filess then
os.execute('cd requfiles ;wget https://raw.githubusercontent.com/TYTBOT/VEER/master/requfiles/serpent.lua') 
dofile('VEER.lua')  
end
local list = VEERBOT:smembers(VEER_ID.."usersbot")
for k,v in pairs(list) do
