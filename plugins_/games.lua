...
if VEERBOT:get(VEER_ID.."chencher"..msg.sender_user_id_) then 
if VEERBOT:get(VEER_ID.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(VEERBOT:get(VEER_ID.."chencher"..msg.sender_user_id_) or '')..']'
...
VEERBOT:set(VEER_ID.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
if text == (VEERBOT:get(VEER_ID..':Set_Hzorh:'..msg.chat_id_) or '&57788') then -- // حزوره
VEERBOT:incrby(VEER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
VEERBOT:del(VEER_ID..':Set_Hzorh:'..msg.chat_id_)
t = '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end

if text == (VEERBOT:get(VEER_ID..':Set_Amthlh:'..msg.chat_id_) or '*678988') then -- // امثله
VEERBOT:incrby(VEER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
VEERBOT:del(VEER_ID..':Set_Amthlh:'..msg.chat_id_)
t = '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end

if text == (VEERBOT:get(VEER_ID..':Set_alii:'..msg.chat_id_) or '*67888') then -- // المختلف
VEERBOT:incrby(VEER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
VEERBOT:del(VEER_ID..':Set_alii:'..msg.chat_id_)
t= '*  🎁  احسنت اجابتك صحيحه   \n*   \n'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
end 

if (text == (VEERBOT:get(VEER_ID.."GAME:CHER"..msg.chat_id_) or '&6-88')) then  
t = '📮¦ اجابتك صحيحه ذكي وربي 😙'
VEER_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md')
VEERBOT:incrby(VEER_ID..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
VEERBOT:del(VEER_ID.."GAME:S"..msg.chat_id_)
VEERBOT:del(VEER_ID.."GAME:CHER"..msg.chat_id_)
...
if VEERBOT:get(VEER_ID.."GAME:S"..msg.chat_id_) then  
...
VEERBOT:set(VEER_ID.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
VEERBOT:set(VEER_ID.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
VEER_sendMsg(msg.chat_id_, msg.id_, 1,SENDTEXT, 1, 'md')
return false  
end
...
VEERBOT:set(VEER_ID..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
VEERBOT:set(VEER_ID..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
VEERBOT:set(VEER_ID..':Set_Hzorh:'..msg.chat_id_,name)
